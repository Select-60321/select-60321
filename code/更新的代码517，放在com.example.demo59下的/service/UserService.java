...
public class UserService {
    ...
    public List<BetweenStationsInfo> findTicketsBetweenStations(String station1, String station2, Date departDate) {
        ...
        for (BetweenStationsInfo info : tmp) {
            ...
            int takenUp = trainMapper.getTrainBoughtCertainTickets(info.getTrainId(), info.getSeatTypeId(), info.getStationIdxFrom(), info.getStationIdxTo(), departDate);
    ...
    public List<BetweenCitiesInfo> findTicketsBetweenCities(String city1, String city2, Date departDate) {
        ...
        for (BetweenCitiesInfo info : tmp) {
            ...
            int takenUp = trainMapper.getTrainBoughtCertainTickets(info.getTrainNum(), info.getSeatTypeId(), info.getStationIdxFrom(), info.getStationIdxTo(), departDate);
            info.setRestTickets(total - takenUp);
        }
        return tmp;
    }
    ...
    public int getTrainCarriageNowBoughtTickets(String trainNumber,
                                                ...
                                                Date departDate) {
        return trainMapper.getTrainCarriageNowBoughtTickets(trainNumber, carriageNo, stationFromIdx, stationToIdx, departDate);
    }
